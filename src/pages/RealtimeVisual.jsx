...
import MapControlButton from "../components/RealTime/MapControlButton";
import StationMap from "../components/RealTime/StationMap";
import LinePlot from "../components/RealTime/LinePlot";
import CompassPlot from "../components/RealTime/CompassPlot";

import "../components/RealTime/RealTimeConditions.css";
...
function RealTimeConditions(props) {
  ...
  let time, y_data;
  if (
    stationIdx < stationData.length &&
    stationData[stationIdx] !== undefined
  ) {
  ...
  switch (chart_type) {
    ...
    case "polar":
      ...
      if (y_data !== undefined) {
        ...
        let [wind_speed, wind_direction] = unzip(
          y_data.slice(y_data.length - 12)
        );
